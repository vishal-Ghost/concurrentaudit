...
const Control = () => {
  ...
  return (
    <>
    <h1 className="display-3" style={{marginLeft:'50px'}}>Control</h1>
  ...
  <div className="form-group">
    ...
    <input type="text" className="form-control" id="ControlId"  placeholder="Control Id"/>
  </div>
  <div className="form-group">
    <label htmlFor="ControlType">Control Type</label>
    <input type="text" className="form-control" id="ControlType"  placeholder="Control type"/>
  </div>
