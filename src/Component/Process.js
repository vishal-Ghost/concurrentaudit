...
const Process = () => {
  ...
  return (
    <>
    <h1 className="display-3" style={{marginLeft:'50px'}}>Process</h1>
  ...
  <div className="form-group">
    ...
    <input type="text" className="form-control" id="BuisnessCriticality"  placeholder="Business Criticality"/>
  </div>
  <div className="form-group">
  ...
  <div className="form-group">
    ...
    <input type="text" className="form-control" id="ProcessId"  placeholder="Process Id"/>
  </div>
